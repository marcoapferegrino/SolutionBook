<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="title   blue-gradient-background" style="border-color: #ffffff; border-radius: 15px 50px; border-width: 15px;;border-style: solid";><b style="color: #f7f7f7"> Solution Book </b><small style="font-size: 50%">.Beta<i class="fa fa-qq " style=" ; color: #f7f7f7"></i></small> </div>
