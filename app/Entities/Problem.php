...
class Problem extends Entity {
    ...
    public function solutionsPreview()
    {
        $previewSolutions = DB::table('solutions')
            ...
            ->select('users.username','solutions.id','users.avatar','solutions.explanation','solutions.state', 'solutions.numLikes','solutions.dislikes','solutions.ranking','code_solutions.limitTime','code_solutions.limitMemory','code_solutions.language')
